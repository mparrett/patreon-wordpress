...
class Patreon_Frontend
{
    ...
    {
        $ret = 'DEBUG: ';
        $ret .= get_user_meta('patreon_refresh_token'); $ret .= '<br/>';
        $ret .= get_user_meta('patreon_access_token'); $ret .= '<br/>';
        $ret .= get_user_meta('patreon_user'); $ret .= '<br/>';
        $ret .= get_user_meta('patreon_created'); $ret .= '<br/>';
        $ret .= get_user_meta('user_firstname'); $ret .= '<br/>';
        $ret .= get_user_meta('user_lastname'); $ret .= '<br/>';
