...
function patreon_plugin_save_post_class_meta($post_id, $post)
{
    ...
    } elseif (isset($_POST['patreon-level']) && ($_POST['patreon-level'] == 0 || $_POST['patreon-level'] == '0')) {
        $new_patreon_level = 0;
    } else {
    ...
    } elseif (($new_patreon_level || $new_patreon_level == 0 || $new_patreon_level == '0') && $new_patreon_level != $patreon_level) {
        update_post_meta($post_id, 'patreon-level', $new_patreon_level);
    } elseif ('' == $new_patreon_level && $patreon_level) {
